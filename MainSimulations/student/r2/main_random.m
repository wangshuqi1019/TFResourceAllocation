...
sorted = sortedRandom;
MaxSimu = 200;
Para_covid.beta = 0.0152/(Para_covid.prop_sym*Para_covid.omega_presym/Para_covid.p_py+(1-Para_covid.prop_sym)*Para_covid.omega_asym);
...
filename = sprintf('results/RANDOM2.0.mat');
